...
public class CalculateController {
    ...
    @GetMapping(path = "/div")
    public String div(@RequestParam("num1") String num1, @RequestParam("num2") String num2) {
        return calculateService.div(num1,num2);
    }

    @GetMapping(path = "/mult")
    public String mult(@RequestParam("num1") String num1, @RequestParam("num2") String num2)  {
